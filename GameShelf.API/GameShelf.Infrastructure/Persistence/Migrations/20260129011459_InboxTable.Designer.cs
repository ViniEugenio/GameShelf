...
namespace GameShelf.Infrastructure.Migrations
{
    ...
    [Migration("20260129011459_InboxTable")]
    partial class InboxTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameShelf.Domain.Entities.Inbox", b =>
                {
                    b.HasOne("GameShelf.Domain.Entities.Outbox", "OutboxEvent")
                        .WithOne("InboxEvent")
                        .HasForeignKey("GameShelf.Domain.Entities.Inbox", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
